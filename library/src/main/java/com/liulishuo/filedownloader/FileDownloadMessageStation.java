...
//    把waitingQueue任务放到disposingList，并且只放固定个数
    private void push() {
...
//                列表的消息全部调用一次handoverMessage();
//                handoverMessage()执行回调
