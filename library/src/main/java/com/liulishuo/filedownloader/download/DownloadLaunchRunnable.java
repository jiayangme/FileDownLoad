...
//                FileDownloadLog.e(this,"header = %s", userRequestHeader.toString());
...
//      尝试请求失败，server数据改变，数据库移除以前的connection
...
//        尝试请求结束只有两种情况：可以接受部分请求或者可以接受重头开始请求
...
//            if(userRequestHeader != null)
//                FileDownloadLog.e(this,"DownloadRunnable header = %s", userRequestHeader.toString());
//            else{
//                FileDownloadLog.e(this,"DownloadRunnable header = %s", "null");
//            }
            if (FileDownloadLog.NEED_LOG) {
